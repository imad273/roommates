...
function Map({ keyword }) {
  const API_KEY = "pk.eyJ1IjoiZW1hZDI3MyIsImEiOiJja3hmdzVqaXYzamJ3MnJvNW53MWc3a3IwIn0.hxBxt4FUMsFkD8mmeFYhbA";
  ...
  async function findCoordinates() {
    const request = await fetch(`https://api.mapbox.com/geocoding/v5/mapbox.places/${keyword}.json?access_token=${API_KEY}`)
    var response = await request.json();
