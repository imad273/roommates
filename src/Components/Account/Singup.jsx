            ...
            <div className="flex flex-col p-6 w-full">
               <div className="mb-6">
                  ...
                  <p className="text-sm text-center text-txt-gray">
                     ...
                     <Link to="/login" className="font-semibold text-primary"> Sing In</Link>
                  </p>
               </div>
               ...
               <form className="flex flex-col mt-2" onSubmit={(e) => { e.preventDefault() }}>
                  ...
                  <button id='sub-btn' onClick={() => { sendData() }} className="bg-primary text-white m-auto mt-1.5 w-2/5 rounded-md p-2">Sing Up</button>
               </form>
            </div>
         </div>
      </div >
